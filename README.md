<p align="center">
  <a href="https://github.com/ClassicDarkPack/Hiddify-Telegram-Bot" target="_blank" rel="noopener noreferrer">
...
```bash
sudo bash -c "$(curl -Lfo- https://raw.githubusercontent.com/ClassicDarkPack/Hiddify-Telegram-Bot/main/install.sh)"
```
<br>
...
- ### Update bot
```bash
cd /opt/Hiddify-Telegram-Bot/ && curl -fsSL -o /opt/Hiddify-Telegram-Bot/update.sh https://raw.githubusercontent.com/ClassicDarkPack/Hiddify-Telegram-Bot/main/update.sh && chmod +x /opt/Hiddify-Telegram-Bot/update.sh && bash /opt/Hiddify-Telegram-Bot/update.sh
```
- ### Restart bot
```bash
...
- ### Reinstall bot
```bash
cd /opt/ && rm -rf /opt/Hiddify-Telegram-Bot/ && sudo bash -c "$(curl -Lfo- https://raw.githubusercontent.com/ClassicDarkPack/Hiddify-Telegram-Bot/main/install.sh)"
```
- ### Uninstall bot
```bash
