...
repository_url="https://github.com/ClassicDarkPack/Hiddify-Telegram-Bot.git"
...
pip install -r requirements.txt --break-system-packages || display_error_and_exit "Failed to install requirements."
